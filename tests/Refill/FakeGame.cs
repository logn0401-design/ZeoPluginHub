...
using System.Linq;
namespace VRage { public struct MyFixedPoint { public double V;public static explicit operator MyFixedPoint(int v)=>new MyFixedPoint{V=v};public static explicit operator double(MyFixedPoint v)=>v.V; } }
namespace VRage.ModAPI {public interface IMyEntity{long EntityId{get;}bool Closed{get;}}}
namespace VRage.Game.ModAPI.Ingame {
 public struct MyItemType {public string TypeId,SubtypeId;}
 ...
 public interface IMyInventory {
  ...
  bool CanTransferItemTo(IMyInventory other,MyItemType item);bool CanItemsBeAdded(VRage.MyFixedPoint amount,MyItemType type);
 }
}
...
namespace Sandbox.ModAPI {
 public interface IMyTerminalBlock:VRage.Game.ModAPI.IMyCubeBlock {bool HasPlayerAccess(long id);bool HasInventory{get;}int InventoryCount{get;}VRage.Game.ModAPI.Ingame.IMyInventory GetInventory(int n);}
...
namespace Sandbox.Game {
 public class MyInventory:VRage.Game.ModAPI.Ingame.IMyInventory {
  public VRage.ModAPI.IMyEntity Owner{get;set;}public double Amount;public string Subtype="sdx_ammomagazinePdc40mm";public int Capacity=100000;public bool Connected=true;
  public static int Requests;public static bool Delayed;public static Action Pending;
  public void GetItems(List<VRage.Game.ModAPI.Ingame.MyInventoryItem> items){if(Amount>0)items.Add(new VRage.Game.ModAPI.Ingame.MyInventoryItem{ItemId=1,Type=new VRage.Game.ModAPI.Ingame.MyItemType{TypeId="MyObjectBuilder_AmmoMagazine",SubtypeId=Subtype},Amount=new VRage.MyFixedPoint{V=Amount}});}
  ...
  public static void TransferByUser(MyInventory src,MyInventory dst,uint id,int slot,VRage.MyFixedPoint amount){Requests++;Action apply=()=>{var n=Math.Min(src.Amount,amount.V);src.Amount-=n;dst.Amount+=n;};if(Delayed)Pending=apply;else apply();}
 }
}
namespace ZeoCore {
 ...
 internal class HudSettings {
  ...
  public bool AmmoOnlyRelevant=true;public double WantPdc40=1000,WantPdc40Improvised=0,WantPdc50=0,WantSabot80=0,WantSabot80Improvised=0,WantSabot100=0,WantTorp160=0,WantTorp190=0,WantTorp220=0;
 }
 internal class HudAmmoStock {public string Key;public bool Relevant;}
...
namespace Fixture {
 ...
 public class Block:IMyTerminalBlock {
